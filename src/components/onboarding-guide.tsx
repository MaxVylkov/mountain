...
const beginnerFaq: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'НП1 — "Начальная подготовка, первый год". Это первый уровень обучения по системе ФАР: две недели в горах, изучение базовых техник, первые восхождения по маршрутам 1Б. По итогам получаешь значок "Альпинист России". Попасть можно через клуб или записавшись напрямую на сборы ФАР.',
  },
  {
  ...
  },
  {
    ...
    a: '3–6 месяцев физической подготовки + 2 недели на учебных сборах НП1. Это минимум. За это время ты освоишь базовые техники и сделаешь первые восхождения на 1Б. Не торопись — фундамент важнее скорости.',
  },
  {
    q: 'Что такое категория сложности 1Б и с чего начинают новички?',
    a: '1Б — простейший класс альпийских маршрутов (категория 1А не существует). Обычно некрутые снежные и осыпные склоны, несложный рельеф. Именно с таких маршрутов начинают новички на сборах НП1. Далее идут 2А, 2Б вплоть до 6Б — технически сложные стены.',
  },
  {
