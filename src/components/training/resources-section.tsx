...
const CATEGORIES: ResourceCategory[] = [
  ...
  {
    label: 'Маршруты и горы',
    resources: [
      {
        title: 'Alpmap.ru — карта альпинистских маршрутов',
        description: 'Интерактивная карта вершин и маршрутов по горным районам России и СНГ: Кавказ, Алтай, Памир, Тянь-Шань, Саяны, Камчатка, Хибины, Крым. Описания, категории сложности.',
        url: 'https://alpmap.ru/',
        tags: ['Маршруты', 'Карта'],
      },
      {
        title: 'Классификатор маршрутов ФАР',
        description: 'Электронный российский классификатор маршрутов на горные вершины — официальные описания, категории, характеристики.',
        url: 'https://alpfederation.ru/mountains/',
        tags: ['ФАР', 'Классификатор'],
      },
    ],
  },
  {
